    ...
    <div class="container">
        ...
        <div class="monitoring-grid">
            <div class="monitoring-item">
                ...
                <iframe src="https://lmeserver.tail8113d2.ts.net/d-solo/30yTZR8Nz/monitoreo-arroyo-mburicao?orgId=2&from=1773318875267&to=1774614875267&panelId=4" frameborder="0"></iframe>
            </div>
            
            <div class="monitoring-item">
                <h3><i class="fas fa-cloud-rain"></i> Precipitation Data</h3>
                <iframe src="https://lmeserver.tail8113d2.ts.net/d-solo/30yTZR8Nz/monitoreo-arroyo-mburicao?orgId=2&from=1773318899962&to=1774614899962&panelId=6" frameborder="0"></iframe>
            </div>
        </div>
